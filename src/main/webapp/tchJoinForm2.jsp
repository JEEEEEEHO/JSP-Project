...
<!-- ------------------------------------------------------	Main 시작 ---------------------------------------------------------->
	<main>
		<form action="tchJoinPro2.do"  enctype="multipart/form-data" method="post">
		<div class="condition1">
			...
			<div id="parent">
				...
				<div class="child">생년월일 </div>
		 		...
		 		<p><br>
		 		<div class="c2"> 이력서 </div>
		 			<input class="button" type="file" name="resume" value="파일첨부" required="required" title="PDF로 첨부하세요." >
